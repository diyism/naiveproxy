...
userspace tsd 到userspace tsd的quic转发 会 报错QUIC path validation fail(source ip 127.0.0.1),
用"TS_DEBUG_MTU=1400 ts-proxy-fixed"+"TS_DEBUG_MTU=1400 caddy-tailscale" 解决:
